...
If the repository ships a hypothesis-ranking helper such as `tools/rank_hypotheses.py`, use it when several next steps look plausible or when a plateau means the search strategy should change.
